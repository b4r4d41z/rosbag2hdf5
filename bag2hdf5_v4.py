...
def convert_bag_to_hdf5(bag_file_path, output_dir, instruction):
    ...
    qpos_raw, qvel, effort, qpos_timestamps = [], [], [], []
    ...
    for t in cam1_timestamps:
        ...
        r6d_l_qpos, rpy_l_qpos, r6d_r_qpos, rpy_r_qpos = compute_fk(
            qpos_raw[idx_q], robot_id, joint_name_to_index,
            left_arm_joints, right_arm_joints
        )
        gripper_left_qpos = hand_state[idx_hand_state][0]
        gripper_right_qpos = hand_state[idx_hand_state][1]
        qpos_vector = np.concatenate([r6d_l_qpos, rpy_l_qpos, [gripper_left_qpos], r6d_r_qpos, rpy_r_qpos, [gripper_right_qpos]])
